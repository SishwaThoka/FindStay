...
<%--<h1>Welcome Tenant, ${member.username}!</h1>--%>
<%--<head>--%>
<%--    <style>--%>
<%--        form,h2 {--%>
<%--            text-align: center;--%>
...
<%--    <input type="text" id="username" name="username" value="${member.username}" readonly><br>--%>

<%--    <label for="name">Name:</label><br>--%>
<%--    <input type="text" id="name" name="name" value="${member.name}" readonly><br>--%>

<%--    <label for="phone_number">Phone Number:</label><br>--%>
<%--    <input type="text" id="phone_number" name="phone_number" value="${member.phone_number}" readonly><br>--%>
<%--</form>--%>
<%--</body>--%>
...
<head>
    <meta charset="UTF-8">
    <title>Welcome Tenant, ${findStayMember.username}!</title>
    <style>
        body {
...
<body>
<div class="header">
    <h1>Welcome Tenant, ${findStayMember.username}!</h1>
</div>
    <div class="container">
    <h2>My Profile</h2>
    <form action="/updateProfile" method="post">
